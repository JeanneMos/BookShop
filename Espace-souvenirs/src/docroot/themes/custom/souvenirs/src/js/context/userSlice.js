...
const initialUserState = {
  isLogged: Cookies.get("userInfo")
    ? JSON.parse(Cookies.get("userInfo"))?.isLogged
    : false,
  isAdmin: false,
  civility: Cookies.get("userInfo")
    ? JSON.parse(Cookies.get("userInfo"))?.civility
    : null,
  lastName: Cookies.get("userInfo")
    ? JSON.parse(Cookies.get("userInfo"))?.lastName
    : null,
  firstName: Cookies.get("userInfo")
    ? JSON.parse(Cookies.get("userInfo"))?.firstName
    : null,
  gp_entities: null,
  defunt: null,
  prestations: [],
