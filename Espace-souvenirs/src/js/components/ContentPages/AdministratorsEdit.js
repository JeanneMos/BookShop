...
const AdministratorPersonalInfoForm = React.lazy(() => import(/* webpackChunkName: "PersonalInfoForm" */'../Forms/AdministratorPersonalInfoForm'));
...
export default function AdministratorsEdit() {
  ...
  if (administratorState.isEditingPersonalInfo) return <AdministratorPersonalInfoForm closeForm={handleCloseForm} />
  ...
  return (
    <>
      ...
      {administratorState?.administrators?.length > 0 && (
        <AdministratorsList />
      )}
      <></>
    </>
