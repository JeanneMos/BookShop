...
export default function ShareButtons() {
  ...
  const handleModalOpen = () => {
    dispatch(modalOpened({theme:"dark", hasCloseButton: true, modalType:"ShareModal"}))
  }
  return (
    <div className="share-buttons-wrapper">
      <Button type="button" btnClass="bg-current share-button" onClickAction={handleModalOpen}>
