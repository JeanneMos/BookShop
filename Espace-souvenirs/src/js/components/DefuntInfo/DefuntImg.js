    ...
    <div className="defunt-img">
      <div className="defunt-img-background">
        {userState?.defuntImage
          ? <img alt="" src={userState.defuntImage.url} width="120" height="120" />
          : <img alt="" src={img} width="120" height="120" /> }
        {userState.isAdmin && (
          <Button dataTestid="defuntImageEdit" btnClass="edit-picture-button" type="button" onClickAction={handleModifyPicture}>
