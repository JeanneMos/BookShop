    ...
    <div className='accueil-agency-wrapper'>
      <div className='agency-wrapper'>
        ...
        <div className='agency-infos'>
          ...
          <p className='agency-zipcode'>{agency_postal_code} {agency_town}</p>
          <div className='agency-contact'>
            {agency_phone && (
              <p className='agency-phone' data-testid="agencyPhone">
                <span>Tel:&nbsp;</span><span className='sr-only'>téléphone</span>
                <StyledLink 
                  as="ahref"
                  linkTo={`tel:${agency_phone}`}
                  linkClass="bg-transparent agency-phone-link">{agency_phone}</StyledLink>
              </p>
            )}
            {agency_url && (
              <StyledLink
