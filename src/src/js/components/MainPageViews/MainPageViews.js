...
import MainPageViewsContent from "../MainPageViewsContent/MainPageViewsContent";
...
const AdministratorsEdit = React.lazy(() =>
  import(
    /* webpackChunkName: "AdministratorsEdit" */ "../MainPageViewsContent/AdministratorsEdit"
  ),
);

export default function MainPageViews() {
